	...
	function saveSchedule(){
		...
		var request = $.ajax({
			...
			success: function(resp){
						...
						if( row.length == 0){
							var row = "<tr onclick=\"selectSchedule(this)\" id=\""+schedulename+"\"><td>"+schedulename+"</td><td>"+reportname+"</td><td>"+format+"</td><td>"+destination+"</td><td>"+startdate+"</td><td>"+recurrence+"</td><td>"+frequency+"</td><td style=\"display:none\">"+foldername+"</td><td style=\"display:none\">"+smtphost+"</td><td style=\"display:none\">"+smtpport+"</td><td style=\"display:none\">"+receiveremail+"</td><td style=\"display:none\">"+senderemail+"</td><td style=\"width:50px\"><img src=\"/lwr/images/sign-delete.png\" onclick=\"deleteSchedule(\'"+schedulename+"\')\"></img></td></tr>";
