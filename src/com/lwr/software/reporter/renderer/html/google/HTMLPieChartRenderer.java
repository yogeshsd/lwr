...
public class HTMLPieChartRenderer extends HTMLAbstractRenderer {

	public HTMLPieChartRenderer(Element element) {
		super(element);
	}
	...
	public String render() {
		...
		html.append("	]);\n");
		html.append("	var chart = new google.visualization.PieChart(document.getElementById('pos_" + element.getPosition() + "'));\n");
