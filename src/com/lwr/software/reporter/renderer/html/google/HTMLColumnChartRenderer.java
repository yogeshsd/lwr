...
public class HTMLColumnChartRenderer extends HTMLAbstractRenderer{

	private boolean isStacked=false;

	public HTMLColumnChartRenderer(Element element,boolean isStacked) {
		super(element);
		this.isStacked = isStacked;
	}
	
	public HTMLColumnChartRenderer(Element element) {
		super(element);
	}
	...
	public String render() {
		...
		html.append("	]);\n");
		html.append("	var chart = new google.visualization.ColumnChart(document.getElementById('pos_"	+ element.getPosition() + "'));\n");
